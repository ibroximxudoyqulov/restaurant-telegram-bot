...
def process_gift_receiver(msg):
    ...
    conn = get_conn()
    c    = conn.cursor()
    # Ҳам бо + ва ҳам бе + ҷустуҷӯ мекунем
    ...
    # Мизоҷ худ ба худ тӯҳфа фиристода наметавонад
    if receiver_id == uid:
...
def step_month(msg):
    ...
    # Рӯз дар моҳ мавҷудлигини текшируви
...
def handle_unknown(msg):
    ...
    # Агар Админ дар ҷараёни илова кардани таом бошад
...
if __name__ == "__main__":
    ...
    # Ҳисоботи рӯзона — алоҳида thread
