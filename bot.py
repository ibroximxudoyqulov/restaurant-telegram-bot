...
def init_db():
    ...
    """)
    # Ҷадвали махсус барои тӯҳфаҳое, ки қабулкунандааш ҳанӯз рўйхат нашудааст
    c.execute("""
...
def cmd_start(msg):
    ...
    # Санҷиши мавҷудияти телефон дар база
    ...
    if not row or not row[0]:
        ...
        # Агар рақам бошад, санҷиш барои тӯҳфаҳои мунтазир
...
def cb_checkout(call):
    ...
    # Модоми ки дар аввал рўйхат шудааст, мустақим ба марҳилаи баъдӣ мегузарем
...
def process_gift_receiver(msg):
    ...
    if phone_clean == bot.get_chat(uid).phone_number or False: # Санҷиши худ ба худ фиристодан
         pass
    ...
    if not row:
        # АГАР РАҚАМ ДАР БАЗА НАБОШАД - ТӮҲФАРО ДАР ОЛИҲОЛ ЗАХИРА МЕКУНЕМ!
        c.execute(
...
if __name__ == "__main__":
    ...
    # Ҳисоботи рӯзона дар алоҳида Thread
